...
### Added
- **Feature Management (Beta)**: Added beta testing for feature management.

### Changed 
- Optimized the AES and DES encryption/decryption UI.
- Optimized overall software performance.

### Fixed
- Fixed language flickering issue on application startup.

## [0.2.3] - 2026-02-14

### Added
- **Regex Tool**: Added capture-group extraction (supports named and numbered groups).

## [0.2.2] - 2026-02-05

### Added
- **Regex Tool**: Added a new Regex tool for testing and debugging regular expressions with real-time matching, highlighting, and flags support.
