...
export function JsonTab() {
  ...
  const handleFormat = () => {
    ...
    try {
      ...
      setIsValid(true)
      setErrorMsg("")
      // addLog({ method: t("tools.formatter.jsonFormat"), input: "JSON", output: t("tools.formatter.formattedSuccessfully") }, "success")
    } catch (e) {
      setIsValid(false)
      setErrorMsg((e as Error).message)
      // addLog({ method: t("tools.formatter.jsonFormat"), input: "JSON", output: (e as Error).message }, "error")
    }
  }
  ...
  const handleMinify = () => {
    ...
    try {
      ...
      setIsValid(true)
      setErrorMsg("")
      // addLog({ method: t("tools.formatter.jsonMinify"), input: "JSON", output: t("tools.formatter.minifiedSuccessfully") }, "success")
    } catch (e) {
      setIsValid(false)
      setErrorMsg((e as Error).message)
  ...
  const handleValidate = () => {
    ...
    try {
      ...
      setIsValid(true)
      setErrorMsg("")
      // addLog({ method: t("tools.formatter.jsonValidate"), input: "JSON", output: t("tools.formatter.validJson") }, "success")
    } catch (e) {
      setIsValid(false)
      setErrorMsg((e as Error).message)
